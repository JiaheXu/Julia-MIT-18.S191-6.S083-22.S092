...
# ╔═╡ b2fa9f5f-644c-45b0-9f1b-db0ae1338ba7
...
# ╔═╡ 5958292c-0b08-4a5a-91d2-f981655a08d3
Agent()
...
# ╔═╡ 22a147f4-3e77-4158-9d8a-53d46477e715
md"""
the bang(!) has nothing to do with other properties, just a naming rule made by the lecturer
"""
...
# ╔═╡ 871cbeec-5666-4a4d-9f6e-9780d89ae1d6
md"""
pᵢ = $(@bind pᵢ Slider(0:.01:0.1, show_value = true ))
pᵣ = $(@bind pᵣ Slider(0:.001:0.01, show_value = true ))
nₚ = $(@bind nₚ Slider(100:100:2000, show_value = true ))
"""
...
struct Reinfection <: AbstractInfection 
	p_infection
	p_recovery # becomes susceptible again 
end
...
function step!(agents::Vector{Agent}, infection::InfectionRecovery)
	...
	interact!(chosen_Agent, chosen_Source, infection) 
...
# ╔═╡ db950c53-8459-471d-a79b-0a0d03db1ec6
...
# ╔═╡ 560d90b1-2929-487a-9115-a4d572cd353f
simulation(3, 20, InfectionRecovery(0.9, 0.2))

# ╔═╡ c8092b14-b140-41a6-a998-567cf6c2d5f6
simulation(100, 1000, InfectionRecovery(0.005, 0.2))

# ╔═╡ e07c6928-c924-4f4f-82c2-81ec6a5c3485
let
	run_basic_sir
...
# ╔═╡ db42f5fa-e9bc-4acc-abbe-c3daddd04dc0


# ╔═╡ e6445da8-0865-4d6a-b751-a9913eb5089d


# ╔═╡ 8954c881-de19-4fba-b81c-275f3b36fd8c
